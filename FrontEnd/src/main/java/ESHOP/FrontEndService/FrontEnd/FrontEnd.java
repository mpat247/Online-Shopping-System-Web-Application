 ...
 */
package ESHOP.FrontEndService.FrontEnd;
...
import ESHOP.FrontEndService.Business.Business;
/**
 *
 * @author student
 */
...
public class FrontEnd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(hiddenParam){
            ...
            case "purchase":
                ...
                RequestDispatcher requestDispatcher = request.getRequestDispatcher("PurchaseConfirm.jsp");
                requestDispatcher.forward(request, response);
        }
    ...
    private ProductsXML retreiveServicesFromBackend(String query, String token) {
