...
public class Authenticate {
    ...
    public Authenticate() {
        ...
        secretString = Encoders.BASE64.encode("mysecuresecurecodemysecuresecurecodemysecuresecurecode".getBytes());
    ...
    public Entry<Boolean, String> verify(String jwt) throws UnsupportedEncodingException {
        ...
        try {
            jws = Jwts.parserBuilder() // (1)
                    .setSigningKey("mysecuresecurecodemysecuresecurecodemysecuresecurecode") // (2)
                    .build() // (3)
